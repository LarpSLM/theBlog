...
export const getInitMyPost = (authorId) => {
    return async function (dispatch) {
        try {
            ...
            dispatch({type: 'MY-POST_INIT_REQUEST_FAIL'});
        }
    }
}
...
export const getScrollPostsAction = (authorId, NPosts) => {
    return async function (dispatch) {
        try {
            ...
            dispatch({type: 'MY-POST_SCROLL_GET_POSTS_FAIL'});
            console.log(e)
        }
    }
};
...
export const deletePostItem = (id) => {
    return async function (dispatch) {
        try {
            ...
            dispatch({type: 'MY-POST_SHOW_MODAL_MESSAGE'});
        }catch (e) {
            console.log(e)
        }
    }
...
export const didMountModalMessage = () => {
    return {type: 'MY-POST_CLOSE_MODAL_MESSAGE'}
}